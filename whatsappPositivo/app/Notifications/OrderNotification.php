...
class OrderNotification extends Notification
{
     ...
     * 
     */
    public function toWhatsappClient($dataClient, $dataComerce)
    {
       //Función para consumir el end point

       $array = json_decode(json_encode($dataComerce), true);
       $commerceph= $array[0]['whatsapp_phone'];
       $commercephone =str_replace("+", "", $commerceph);

       $customername = $dataClient[0]['client'];
       $customerphone = $dataClient[0]['phone'];
       ...
       if ($this->status.'' == '1') {
            ...
            //Assigned to driver
            $orderstatus = 'asignado al conductor';
       ...
       $data = array(
        'whastPhCli' => $customerphone,
        'nameCli' => $customername,
        'statusOrder' => $orderstatus,
        'WhastPhCom' => $commercephone,
        'orderId' => $orderid
        );
    ...
    //     CURLOPT_URL => 'http://178.128.189.146/api/shops/sendMessage',
    ...
    //         'Authorization: Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOnsiaWQiOiI1NzMwMTc4NjIwMTEifSwiaWF0IjoxNjM5NTE4NDg3LCJleHAiOjE2Mzk2MDQ4ODd9.ojV-lc49FsmiDOfHMOpQXLGwl3QCcNVqBnoNOHFjOKI'
    //     ),
    //     ));

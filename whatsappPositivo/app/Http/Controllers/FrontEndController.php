...
class FrontEndController extends Controller
{
    ...
    public function restorant($alias)
    {
        ...
        if ($restorant && $restorant->active == 1) {
           ...
           //Consulta de rede sociales comercios
           //Hernan 2022-02-21
           $allNetworks = Redes::select('nombre','url')->where('IDcompanies', $restorant->id)->get();
           $networks = [];
           foreach ($allNetworks as $key => $net) {
                $networks[$net->nombre] = $net->url;
           }
           ///////////////////////////////////

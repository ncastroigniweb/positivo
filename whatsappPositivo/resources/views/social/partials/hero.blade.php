            ...
            <div class="row">
                  ...
                  <h2 class="text-white mb-4">
                        ...
                        <ul class="list-unstyled ml-lg-auto text-white">
                            <li><img style="width: 5%;" src="{{ asset('social') }}/img/check.png" alt=""> Potencializamos y automatizamos el contacto con sus clientes.</li>
                            <li><img style="width: 5%;" src="{{ asset('social') }}/img/check.png" alt=""> Crea tu catálogo comercial.</li>
                            <li><img style="width: 5%;" src="{{ asset('social') }}/img/check.png" alt=""> Administra los reportes y estadisticas.</li>
                        </ul>
                        <div class="mt-5">
                            @if(auth()->user()&&auth()->user()->hasRole('admin'))

...
<head>
    ...
    })(window,document,'script','dataLayer','GTM-KKGCD87');</script>
    ...
    j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
    'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
    })(window,document,'script','dataLayer','GTM-MFJ7TX7');</script> --}}
    <!-- End Google Tag Manager -->
    ...
    {{-- <script async src="https://www.googletagmanager.com/gtag/js?id=G-E44N26NZ0M"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-E44N26NZ0M');
    </script> --}}
    <!-- Global site tag (gtag.js) - Google Analytics -->
    ...
    <!---- Chat CSS --------->
    <link href="{{ asset('social') }}/css/floating-wpp.css" rel="stylesheet" />
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KKGCD87" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->

<!-- Google Tag Manager (noscript) -->
{{-- <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PXFBP23" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript> --}}
<!-- End Google Tag Manager (noscript) -->
 ...
 {{-- <script>
  ...
  <!-- Google Tag Manager (noscript) -->
{{-- <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MFJ7TX7"
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <div class="wrapper">
   ...
   <!-- END MAIN WRAPPER-->
   <!--- CHAT FLOATING -->
   @include('social.partials.floatingchat')
  ...
  <script src="{{ asset('social') }}/js/floating-wpp.js?v=1.2.2" type="text/javascript"></script>

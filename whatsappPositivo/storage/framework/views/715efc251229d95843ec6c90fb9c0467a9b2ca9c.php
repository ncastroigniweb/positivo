                            ...
                            <div class="card" style="width: 18rem;">
                                ...
                                <?php if($app->installed): ?>
                                    ...
                                    <?php if($app->updateAvailable): ?>
                                        <a target="_blank" href="<?php echo e($app->link); ?>" class="btn btn-sm btn-outline-primary"><?php echo e(__('Update available')); ?></a>
                                    <?php endif; ?>
                                <?php else: ?>
                                <?php if(isset($app->gr)): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', ['title' => __('Settings')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/positivo/whatsapp.positivo.co/resources/views/apps/index.blade.php ENDPATH**/ ?>
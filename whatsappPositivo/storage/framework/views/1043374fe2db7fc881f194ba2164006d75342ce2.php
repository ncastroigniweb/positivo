        ...
        <div class="col">
            ...
            <div class="row">
                  ...
                  <h2 class="text-white mb-4">
                        ...
                        <ul class="list-unstyled ml-lg-auto text-white">
                            <li><img style="width: 5%;" src="<?php echo e(asset('social')); ?>/img/check.png" alt=""> Potencializamos y automatizamos el contacto con sus clientes.</li>
                            <li><img style="width: 5%;" src="<?php echo e(asset('social')); ?>/img/check.png" alt=""> Crea tu catálogo comercial.</li>
                            <li><img style="width: 5%;" src="<?php echo e(asset('social')); ?>/img/check.png" alt=""> Administra los reportes y estadisticas.</li>
                        </ul>
                        <div class="mt-5">
                            <?php if(auth()->user()&&auth()->user()->hasRole('admin')): ?>
                            <div class="ckedit btn btn-icon btn-neutral rounded-pill" key="start_now" id="start_now">
                            ...
                            <?php else: ?>
                            <button type="button" class="btn btn-icon btn-neutral rounded-pill" data-toggle="modal"
...
<?php /**PATH /home/positivo/whatsapp.positivo.co/resources/views/social/partials/hero.blade.php ENDPATH**/ ?>
<div class="pl-lg-4">
    <form id="restorant-form" method="post" action="<?php echo e(route('admin.restaurants.update', $restorant)); ?>" autocomplete="off" enctype="multipart/form-data">
        ...
        <input type="hidden" name="keyWhatsApi" id="keyWhatsApi" value="<?php echo e($restorant->keyWhatsApi); ?>">
...
<?php /**PATH /home/positivo/whatsapp.positivo.co/resources/views/restorants/partials/info.blade.php ENDPATH**/ ?>
...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <!-- Global site tag (gtag.js) - Google Analytics For Igniweb -->
    ...
    <body class="<?php echo e($class ?? ''); ?>">
        ...
        <!-- Custom JS function api whatsapp bot 2021-14-11 Daruin Herrera -->
        <script src="<?php echo e(asset('custom')); ?>/js/wa.js"></script>
        <script src="<?php echo e(asset('custom')); ?>/js/customer.js"></script>

      
    </body>
</html>
<?php /**PATH /home/positivo/whatsapp.positivo.co/resources/views/layouts/app.blade.php ENDPATH**/ ?>
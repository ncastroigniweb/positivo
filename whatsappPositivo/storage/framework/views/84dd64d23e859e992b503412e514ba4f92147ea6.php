<nav id="navbar-main" class="navbar navbar-light navbar-expand-lg fixed-top">
    ...
    <div class="container-fluid">
        ...
        <button class="navbar-toggler" style="background-color: #fff;" type="button" data-toggle="collapse" data-target="#navbar_global" aria-controls="navbar_global" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="navbar-collapse collapse" id="navbar_global">
          ...
          <ul class="navbar-nav align-items-lg-center ml-lg-auto">
            ...
            <a type="button" class="nav-link" id="pg-nosotros">
                <span class="btn-inner--icon">
                    <i class="fa fa-users"></i>
                </span>
                <span class="nav-link-inner--text">Nosotros</span>
              </a>
              <a type="button" class="nav-link" id="pg-cont-ctenos">
                <span class="btn-inner--icon">
                    <i class="fa fa-phone"></i>
                </span>
                <span class="nav-link-inner--text">Contáctenos</span>
              </a>
              <a type="button" class="nav-link" id="pg-preguntas-frecuentes">
                <span class="btn-inner--icon">
                    <i class="fa fa-question"></i>
                </span>
                <span class="nav-link-inner--text">Preguntas frecuentes</span>
              </a>
              <a type="button" class="nav-link" id="pg-ubicaci-n">
                <span class="btn-inner--icon">
...
<?php /**PATH /home/positivo/whatsapp.positivo.co/resources/views/layouts/menu/top_justlogo.blade.php ENDPATH**/ ?>
        ...
        <figure>
            <blockquote class="blockquote">
                <p>
                    ...
                    </svg> <?php echo e(__("Settings whatsapp")); ?>
            ...
            <div class="container text-black bg-white rounded" style="padding: 30px;">
                <div class="row">
                    ...
                    <div class="col-md-6 text-center" style="display: none" id="scan_qr">                                             
                        ...
                        <figcaption class="blockquote-footer">
                            Clic <cite title="Source Title"> para vincular el dispositivo <?php echo e($restorant->whatsapp_phone); ?></cite>
                        </figcaption>
                        </p>
                    </div>
                    <div class="col-md-6 text-center" id="spinerVal"> 
                        ...
                        <figcaption class="blockquote-footer">
                            Validando <cite title="Source Title">sesión <?php echo e($restorant->whatsapp_phone); ?></cite>
                        </figcaption>
                    </div>                   
                </div>
            </div>
...
<?php /**PATH /home/positivo/whatsapp.positivo.co/resources/views/restorants/partials/whatsappApi.blade.php ENDPATH**/ ?>
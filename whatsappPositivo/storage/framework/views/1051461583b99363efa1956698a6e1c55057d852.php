    ...
    <div class="container-fluid">
        <div class="nav-wrapper">
            <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="res_menagment" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link mb-sm-3 mb-md-0" id="tabs-menagment-main" data-toggle="tab" href="#whatappApi" role="tab" aria-controls="tabs-menagment" aria-selected="true"><i class="fa fa-whatsapp" aria-hidden="true"></i> <?php echo e(__('Whatsapp Api')); ?></a>
                </li>
            </ul>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="tab-content" id="tabs">
                ...
                <!--- Tab  whatsappApi ----->
                <div class="tab-pane fade show" id="whatappApi" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                    <?php echo $__env->make('restorants.partials.whatsappApi', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
...
<?php echo $__env->make('layouts.app', ['title' => __('Orders')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/positivo/whatsapp.positivo.co/resources/views/restorants/edit.blade.php ENDPATH**/ ?>
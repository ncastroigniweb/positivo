...
$(document).ready(function() {
    $('input[type="checkbox"],[type="radio"]').not('.skip, #status, #top_list').iCheck({
...
$(document).ready(function() {
    ...
    $('body').on('click', '.other_profit_link td:not(:last-child)', function() {
        $('#myModal').modal({remote: site.base_url + 'profits/profit_note/' + $(this).closest('tr').attr('id')});
        $('#myModal').modal('show');
    });

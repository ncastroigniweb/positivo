                        ...
                        <div class="col-sm-6">
                            <div class="small-box padding1010 bdarkGreen">
                                ...
                                <p><?= $this->sma->formatMoney($total_sales->total) . ' ' . lang('sales') ?>
                                    ...
                                    & <?= $this->sma->formatMoney($total_sales->tip) . ' ' . lang('tip') ?> </p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-4">
                            <div class="small-box padding1010 bred">
                                ...
                                <h3 class="bold"><?= $this->sma->formatMoney($total_sales->total_amount - $total_purchases->total_amount - $total_sales->tip) ?></h3>
                                ...
                                <p><?= $this->sma->formatMoney($total_sales->total_amount) . ' ' . lang('sales') ?>
                                    ...
                                    - <?= $this->sma->formatMoney($total_sales->tip) . ' ' . lang('tips') ?></p>
                            </div>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <div class="small-box padding1010 bblue">
                                ...
                                <h3 class="bold"><?= $this->sma->formatMoney(($total_sales->total_amount - $total_sales->tax - $total_sales->tip) - ($total_purchases->total_amount - $total_purchases->tax)) ?></h3>

                                <p>(<?= $this->sma->formatMoney($total_sales->total_amount) . ' ' . lang('sales') ?>
                                    - <?= $this->sma->formatMoney($total_sales->tax) . ' ' . lang('tax') ?>
                                    - <?= $this->sma->formatMoney($total_sales->tip) . ' ' . lang('tips') ?>) -
                                    (<?= $this->sma->formatMoney($total_purchases->total_amount) . ' ' . lang('purchases') ?>
                                    - <?= $this->sma->formatMoney($total_purchases->tax) . ' ' . lang('tax') ?>)</p>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-6">
                            <div class="small-box padding1010 blightBlue">
                                <h4 class="bold"><?= lang('total_profit') ?></h4>
                                <i class="fa fa-money"></i>

                                <h3 class="bold"><?= $this->sma->formatMoney($total_received->total_amount - $total_sales->tax - $total_sales->tip + $total_returned->total_amount - $total_expenses->total_amount) ?></h3>
                        ...
                        <div class="col-sm-2">
                            <div class="small-box padding1010 bgrey">
                                <h4 class="bold"><?= lang('tips') ?></h4>
                                <i class="fa fa-usd"></i>

                                <h3 class="bold"><?= $this->sma->formatMoney($total_sales->tip) ?></h3>

                                <p class="bold"><?= $this->sma->formatMoney($total_sales->tip) . ' ' . lang('tips') ?></p>
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="small-box padding1010 blightOrange">
                                <h4 class="bold"><?= lang('other_profits') ?></h4>
                                <i class="fa fa-usd"></i>

                                <h3 class="bold"><?= $this->sma->formatMoney($total_other_profits->total_amount) ?></h3>

                                <p class="bold"><?= $this->sma->formatMoney($total_other_profits->total_amount) . ' ' . lang('other_profits') ?></p>
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="small-box padding1010 bred">
                                ...
                                <h3 class="bold"><?= $this->sma->formatMoney($total_sales->discount) ?></h3>

                                <p class="bold"><?= $this->sma->formatMoney($total_sales->discount) . ' ' . lang('discount') ?></p>
                            </div>
                        </div>
                    </div>
                </div>

        ...
        <div class="text-center">
            ...
            <?php
                ...
                if ($Settings->show_reference) {
            	    echo '<tr class="row_title_bill"><td class="title_view_bill">' . lang("reference_no_uppercase") . ': </td><td class="data_title_bill">' . (int)$inv->bill_no . '</td></tr>';
                }
                ...
                echo '<table class="content_table_bill"><tr><td>'. lang("waiter_name") . ':</td> <td class="content_table_bill_right">' . $inv->waiter_name .'</td></tr>';
...
<!--                    </tr>-->
            ...
            <div class="well well-sm" style="text-align: center">
                Documento  oficial de autorización de numeración  de facturación  N° 18762001630335
                fecha: 22/12/16 Númeracion autorizada del 0001 a la 10000 Tarifa ICA 0,01 Act ICA 308 <br><br>

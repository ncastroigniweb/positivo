                                ...
                                <div class="quick-add">
                                    <?php if(!isset($categories['code'])){ ?>
                                        <?php foreach($categories as $category) { ?>
                                            <button
                                                onclick=" ajax_show_products(<?= $category['id'] ?>)"
            ...
            <div class="ng-scope">
                ...
                <h3>
                    ...
                    <span class="text-right">
                        <i class="fa fa-search button-search" title="<?= lang('products_search') ?>" aria-hidden="true"></i><span
                            class="sr-only"><?= lang('products_search') ?></span>
                    </span>
                </h3>
                <section>
                    <!-- Product search -->
                    <div class="adder hide u_display_block">
                        <div class="adder-product autocomplete">
                            <input type="text" autofocus="" id="bs-prods"
                                   class="input ng-pristine ng-valid ng-isolate-scope ng-empty ng-touched"
                                ...
                                <li class="status-new ng-scope ">
                                    <div class="item">
                                        <div class="incrementer">
                                            ...
                                            <input name="qty" id="orp_cantidad" value="1" size="4"
                                                   class="shy" max="99" min="1" required="" type="number">
                                            <a id="plus">
                                        ...
                                        <button class="button-icon button-simple" title="<?= lang('cancel') ?>" type="button"
                                                onclick="cancelDetail(this)">
                                            <span class="icon icon-x"></span>
                                        </button>
                                    </div>
                                    <div class="addition-comment ng-hide">
                                        <input name="comments" id="orp_descripcion"
                                               class="shy ng-pristine ng-untouched ng-valid ng-isolate-scope ng-empty"
                    ...
                    <div class="button-container end">
                        ...
                        <?php if ($products && $unconfirmed > 0) { ?>
                            <button id="product_confirm" onclick="window.location.href='tables/order/confirm/<?= $table->id ?>'"
                                    class="button button-action btn-confirm-3 u_float_left">
                                <i class="fa fa-exclamation-triangle faa-flash animated icon-alert-confirm" aria-hidden="true"></i> <?= lang('confirm') ?>
                            </button>
                        <?php } ?>
...
<div id="bill_tbl">
    <style>.table_bill, .table_bill th, .table_bill td { border-collapse:collapse; border-bottom: 1px solid #CCC; } .no-border { border: 0; } .bold { font-weight: bold; } #bill_span h3 { display: block; } </style>
    ...
    <table id="bill-table" class="table_bill prT table table-striped" style="margin-bottom:0;width: 100%;">
        ...
        foreach ($products_array as $product) { ?>
            ...
            <span class="name">
                ...
                <td class="price ng-binding"
                    style="text-align:right;"><?= $this->Settings->symbol ?><?= $this->sma->formatDecimal($product['price']) ?></td>
            </tr>

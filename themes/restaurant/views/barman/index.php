                    ...
                    <table class="data stated">
                        ...
                        <?php foreach ($list_products as $pending_product) { ?>
                            <tr id="<?= $pending_product->id; ?>" class="status-in_course
                                    ...
                                    <?= ($pending_product->subcategory_id == 27) ? ' bisque' : '' ?>
                                    <?= ($pending_product->subcategory_id == 28) ? ' darksalmon' : '' ?>">
                                <td class="ng-binding ">
                                    <button id="btn-waiting" class="btn btn-info ng-scope  ng-isolate-scope" title="<?= lang("chef_barman_hold"); ?>">
                                        <div id="table_<?= $pending_product->id; ?>"><?= $pending_product->table_name; ?></div>
                                    </button>
                                </td>
                                <td class="ng-binding ">
                                ...
                                <td>
                                    <div class="ng-binding  ng-isolate-scope u_font_20 inline_block">
                                    ...
                                    <div class="addition-comment ng-hide u_font_20 inline_block">
                                        <p class="ng-binding comment"><?php if($pending_product->comments != null){ echo " - " . ucfirst($pending_product->comments);} ?></p>
                                    </div>
                                </td>
                                <td id="minutes_<?= $pending_product->id; ?>"><?= $pending_product->diff_minutes; ?></td>
                                <td>
                        ...
                        <?php foreach ($list_tables as $list_table) { ?>
                            <div class="table-grid modal-chef-barman-tables">
                                <div class="table-placeholder status-occupied container-table">
                                    <a class="table" href="barman/view/<?= $list_table->id; ?>">
                                    ...
                                    <li class="ng-scope confirmed">
                                        <div class="item">
                                            ...
                                            <button class="button-icon button-simple ng-scope ng-isolate-scope"
                                                    onclick="window.location.href='barman/dispatch/<?= $product->id ?>' ">

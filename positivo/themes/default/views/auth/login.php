                    ...
                    <div class="login-content">
                        <div class="text-center">
                            <?php //if ($Settings->logo2) {
                                echo '<img src="' . base_url('assets/uploads/logos/logo.png') .'" alt="' . $Settings->site_name . '" style="margin-bottom:10px; margin-top:10px; max-width: 330px; max-height: 150px;" />';
                            //} ?>
                        </div>
                        ...
                        <div class="form-action col-sm-12">
                            ...
                            <button type="submit" class="btn btn-restaurant pull-right"><?= lang('login') ?> &nbsp; <i class="fa fa-sign-in"></i></button>
                        </div>
                        <?php echo form_close(); ?>

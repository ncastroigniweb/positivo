        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group all">
                        <?= lang("premium_product_price", "premium_price") ?>
                        <?= form_input('premium_price', (isset($_POST['premium_price']) ? $_POST['premium_price'] : ($product ? $this->sma->formatDecimal($product->premium_price) : '')), 'class="form-control tip" id="premium_price"') ?>
                    </div>
                        ...
                        <div class="onoffswitch">
                            ...
                            <?php 
                                $data = array(
                                        ...
                                        'id'            => 'status',
                                        'value'         => 1,
                                        'checked'       => set_value('status', $product->status),

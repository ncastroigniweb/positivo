    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <?php } ?>
                <div class="col-sm-6 <?= ($Owner || $Admin)? "" : "display_none" ;?> ">
                    <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="payment">
                                    <div class="form-group">
                                        <?= lang("amount", "amount_payment"); ?>
                                        <input name="amount-paid"
                                               value="<?= $this->sma->formatDecimal($payment->amount); ?>" type="text"
                                               id="amount_payment" class="pa form-control kb-pad amount"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="payment">
                                    <div class="form-group">
                                        <?= lang("paid_amount", "paid_amount_1"); ?>
                                        <input name="pos-paid"
                                               value="<?= $this->sma->formatDecimal($payment->pos_paid); ?>" type="text"
                                               id="paid_amount_1" class="pa form-control kb-pad amount"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <?= lang("balance", "balance_amount_pay"); ?>
                                    <input name="balance"
                                               value="<?= $this->sma->formatDecimal($payment->pos_paid - $payment->amount); ?>" type="text"
                                               id="balance_amount_pay" class="pa form-control kb-pad amount"/>
                                </div>
                            </div>
...
<script type="text/javascript" charset="UTF-8">
    $(document).ready(function () {
        ...
        $('#paid_amount_1').change(function (e) {
            $('#balance_amount_pay').val( $('#paid_amount_1').val() - $('#amount_payment').val() );
        });
    });
</script>

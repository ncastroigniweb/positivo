                            ...
                            <?php if ($Owner) { 
                                ...
                                <li class="mm_system_settings <?= strtolower($this->router->fetch_method()) != 'settings' ? '' : 'mm_pos' ?>">
                                    ...
                                    <ul>
                                        ...
                                        <li id="system_settings_tip_rates">
                                            <a href="<?= site_url('system_settings/tip_rates') ?>">
                                                <i class="fa fa-plus-circle"></i><span class="text"> <?= lang('tip_rates'); ?></span>
                                            </a>
                                        </li>
                                    ...
                                    <li class="mm_dian">
                                        <a class="submenu"  href="<?= site_url('dian') ?>">
                                            <i class="fa fa-university"></i>
                                            <span class="text"> <?= lang('dian'); ?> </span>
                                        </a>
                                    </li>
                                </li>
                            <?php }
                           ?>
                            ...
                            <?php if ($Owner) { ?>
                                <li class="mm_profits">
                                    <a class="dropmenu" href="#">
                                        <i class="fa fa-dollar"></i>
                                        <span class="text"> <?= lang('other_profits'); ?> </span>
                                        <span class="chevron closed"></span>
                                    </a>
                                    <ul>
                                        <li id="profits_list">
                                            <a class="submenu" href="<?= site_url('profits'); ?>">
                                                <i class="fa fa-dollar"></i><span class="text"> <?= lang('list_other_profits'); ?></span>
                                            </a>
                                        </li>
                                        <li id="profits_add">
                                            <a class="submenu" href="<?= site_url('profits/add_OtherProfits'); ?>" data-toggle="modal" data-target="#myModal">
                                                <i class="fa fa-plus-circle"></i><span class="text"> <?= lang('add_other_profits'); ?></span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>

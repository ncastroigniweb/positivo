...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="onoffswitch">
                    ...
                    $data = array(
                            ...
                            'id'            => 'status',
                            'value'         => 1,
                            'checked'       => set_value('status', $category->status),
            ...
            <div class="form-group">
                <?= lang("category_top_list", "top_list") ?>
                <div class="onoffswitch">
                    ...
                    $data = array(
                            ...
                            'id'            => 'top_list',
                            'value'         => 1,
                            'checked'       => set_value('top_list', $category->top_list),
                            'class'         => 'onoffswitch-checkbox'
                    );
                    ...
                    <label class="onoffswitch-label" for="top_list">
                        <span class="onoffswitch-inner"></span>
                        <span class="onoffswitch-switch"></span>
                    </label>
                </div>

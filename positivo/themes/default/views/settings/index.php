        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <label class="control-label"><?= lang("date_format_chef"); ?></label>
                        <div class="form-group">
                            <div class="form-group col-md-4">
                                <label class="control-label" for="date_format_chef_hour"><?= lang("hours"); ?></label>
                                <?php
                                echo form_checkbox(array('name' => 'date_format_chef_hour', 'id' => 'date_format_chef_hour', 'value' => TRUE, 'checked' => (strpos($settings->date_format_chef, "H") !== false)));
                                ?>
                            </div>
                            <div class="form-group col-md-4">
                                <label class="control-label" for="date_format_chef_min"><?= lang("min"); ?></label>
                                <?php
                                echo form_checkbox(array('name' => 'date_format_chef_min', 'id' => 'date_format_chef_min', 'value' => TRUE, 'checked' => (strpos($settings->date_format_chef, "i") !== false)));
                                ?>
                            </div>
                            <div class="form-group col-md-4">
                                <label class="control-label" for="date_format_chef_seg"><?= lang("seg"); ?></label>
                                <?php
                                echo form_checkbox(array('name' => 'date_format_chef_seg', 'id' => 'date_format_chef_seg', 'value' => TRUE, 'checked' => (strpos($settings->date_format_chef, "s") !== false)));
                                ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <?= lang("delay_product", "delay_product"); ?>
                            <?= form_input('delay_product', $Settings->delay_product, 'class="form-control tip" id="delay_product"  required="required"'); ?>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <label class="control-label"><?= lang("days_active_premium_price"); ?></label>
                        <div class="form-group">
                        <?php
                            $days = array('Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday');
                            foreach ($days as $day) { ?>
                                <div class="form-group days_premium_price">
                                    <label class="control-label" for="<?= strtolower($day); ?>_premium_price"><?= lang("cal_" . strtolower($day)); ?></label>
                                    <?php
                                    echo form_checkbox(array('name' => strtolower($day) . '_premium_price', 'id' => strtolower($day). '_premium_price', 'value' => TRUE, 'checked' => (strpos($settings->days_premium_price, $day) !== false)));
                                    ?>
                                </div>
                        <?php } ?>
                        </div>
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("invoice_tax", "tax_rate2"); ?>sdsddsdsdsdsds
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label"
                                       for="show_reference"><?= lang("show_reference"); ?></label>

                                <div class="controls">
                                    <?php
                                    echo form_dropdown('show_reference', $ps, $Settings->show_reference, 'id="show_reference" class="form-control tip" required="required" style="width:100%;"');
                                    ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label" for="sale_tax_method"><?= lang("sale_tax_method"); ?></label>

                                <div class="controls">
                                    <?php
                                    $sale_tax_method = array(0 => lang('inclusive'), 1 => lang('exclusive'));
                                    echo form_dropdown('sale_tax_method', $sale_tax_method, $Settings->sale_tax_method, 'class="form-control tip" required="required" id="invoice_view" style="width:100%;"');
                                    ?>
                                </div>
                            </div>
                        </div>

...
class Settings_model extends CI_Model
{
    ...
    public function addTipRate($data)
    {
        if ($this->db->insert('tip_rates', $data)) {
            return true;
        }
        return false;
    }

    public function updateTipRate($id, $data = array())
    {
        $this->db->where('id', $id);
    ...
    public function deleteTipRate($id)
    {
        if ($this->db->delete('tip_rates', array('id' => $id))) {
            return true;
        }
        return FALSE;
    }

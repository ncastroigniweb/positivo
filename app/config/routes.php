...
//Mozo  Spanish Routes
$route['mozo'] = 'waiters';
$route['mozo/ordenes/crear/(:num)'] = 'tables/orders/create/$1';

// Chef Routes
$route['cocina'] = 'chef';
$route['cocina/ver/(:num)'] = 'chef/index/view/$1';
$route['chef/view/(:num)'] = 'chef/index/view/$1';
$route['chef/dispatch/(:num)'] = 'chef/index/dispatch/$1';

// Barman Routes
$route['barman/ver/(:num)'] = 'barman/index/view/$1';
$route['barman/view/(:num)'] = 'barman/index/view/$1';
$route['barman/dispatch/(:num)'] = 'barman/index/dispatch/$1';